...
if(isset($_REQUEST['search_button'])=== true){
    ...
    if($_REQUEST['song_title'] == $song_lyrics1){
        ...
        header("Location: ".$url_add."?superfar");
    }
    else if($_REQUEST['song_title'] == $song_lyrics3){
        header("Location: ".$url_add."?istilltalktojesus");
    }
                    ...
                    <div class="col-lg-12 text-center">
                        <form method="POST" class="login-form">
                            <div class="form-group">
                                ...
                                }else if(isset($_REQUEST['superfar'])=== true){
                                    echo "Redirecting...";
                                    header ("Refresh: 3; url=song2.php");
                                }else if(isset($_REQUEST['istilltalktojesus'])===true){
                                    echo "Redirecting...";
